Tþf<?php exit; ?>a:6:{s:10:"last_error";s:0:"";s:10:"last_query";s:449:"SELECT  smmwpstudio_comments.comment_ID
			 ...
			 WHERE ( comment_approved = '1' ) AND  smmwpstudio_posts.post_status IN ('publish') AND pll_tr.term_taxonomy_id IN ( 5 )
