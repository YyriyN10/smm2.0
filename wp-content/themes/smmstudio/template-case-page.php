<?php
	 ...
	 *
	 * Template name: Шаблон страницы кейса
	 *
...
?>
<style type="text/css">
	.case-about-info .dev-content-part .dev-part .part-text p{
		margin-bottom: 10px;
	}
	
	.case-about-info .part-about ol {
        margin: 0 0 15px 0;
        padding: 0;
        padding-left: 20px;
	}
		...
		<section class="case-about-info" id="case-main-info">
			<div class="part-1">
				<div class="container">
					...
					<div class="row part-item">
                        <?php if( $caseCatContentType['value'] == 'developt'):?>
						    <h2 class="part-name col-sm-4"><?php echo $textSolution;?></h2>
                        <?php else:?>
                            <h2 class="part-name col-sm-4"><?php echo $textStartData;?></h2>
                        <?php endif;?>
						<div class="part-about col-sm-8"><?php echo $case_initial_data['opisanie'];?></div>
					</div>
				</div>
			</div>
			<?php
                if ( $caseCatContentType['value'] == 'developt'):
            ...
            ?>
                <div class="dev-content-part">
                    <div class="container">
                        <div class="row">
                            <h2 class="part-name col-12"><?php echo $textWhatDid;?></h2>
                        </div>
                    </div>
                    <?php
                        $optionBlocks = $devContentCase['blok_opisaniya'];
                        $textBlock = $devContentCase['tekstovoe_opisanie'];
                        $protoBlock = $devContentCase['opisanie_prototipa'];
                        $designBlock = $devContentCase['dizajn'];
                        $adaptiveBlock = $devContentCase['adaptiv'];
                    ?>
                        <?php foreach ( $optionBlocks as $block):?>
                            <?php if ( $block['value'] == 'project'):?>
                                <div class="container">
                                    <div class="row">
                                        <div class="dev-part col-12">
                                            <h3><?php echo $protoBlock['podzagolovok'];?></h3>
                                            <div class="part-text">
                                                <?php echo $protoBlock['opisanie'];?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="image-wrapper">
                                    <img src="<?php echo $protoBlock['kartinka'];?>" alt="">
                                </div>
                            <?php endif;?>
	                        <?php if ( $block['value'] == 'design'):?>
                                <div class="container">
                                    <div class="row">
                                        <div class="dev-part col-12">
                                            <h3><?php echo $designBlock['podzagolovok'];?></h3>
                                            <div class="part-text">
						                        <?php echo $designBlock['opisanie'];?>
                                            </div>
                                            <div class="color-fonts-wrapper">
                                                <div class="color-wrapper">
                                                    <h3><?php echo $textColor;?></h3>
                                                    <div class="inner">
		                                                <?php foreach ( $designBlock['czveta'] as $item ):?>
                                                            <div class="color-item">
                                                                <div class="color-prev" style="background: <?php echo $item['czvet'];?>"></div>
                                                                <p><?php echo $item['czvet'];?></p>
                                                            </div>
                                                        <?php endforeach;?>
                                                    </div>
                                                </div>
                                                <div class="fonts-wrapper">
                                                    <h3><?php echo $textTipograf;?></h3>
	                                                <?php foreach ( $designBlock['tipografika'] as $item ):?>
                                                        <p><?php echo $item['nazvanie_shrifta'];?></p>
	                                                <?php endforeach;?>
                                                </div>
                                            </div>
                                        </div>
		                        ...
		                        <?php
		                        $disOptionsBlocks = $designBlock['oczionalnye_bloki'];

		                        foreach ( $disOptionsBlocks as $disOption ):
			                        ?>
			                        <?php if ( $disOption['value'] == 'blocktp1'):?>
                                        <div class="container">
                                            <div class="row dev-part">
                                                <div class="screen-wrapper col-12">
                                                    <h3><?php echo $designBlock['blok_so_skrollom_v_makape']['podzagolovok'];?></h3>
                                                    <div class="part-text">
                                                        <?php echo $designBlock['blok_so_skrollom_v_makape']['opisanie'];?>
                                                    </div>
                                                    <div class="screen">
                                                        <img src="<?php echo $designBlock['blok_so_skrollom_v_makape']['kartinka'];?>" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
		                            <?php endif;?>
			                        <?php if ( $disOption['value'] == 'blocktp2'):?>
                                        <div class="container">
                                            <div class="row dev-part">
                                                <div class="pic-text-wrapper col-12">
                                                    <h3><?php echo $designBlock['blok_s_opisaniem_i_kartinkoj']['podzagolovok'];?></h3>
                                                    <div class="part-text">
                                                        <?php echo$designBlock['blok_s_opisaniem_i_kartinkoj']['opisanie'];?>
                                                    </div>
                                                    <img src="<?php echo $designBlock['blok_s_opisaniem_i_kartinkoj']['kartinka'];?>" alt="">
                                                </div>
                                            </div>
                                        </div>
		                            <?php endif;?>
			                        <?php if ( $disOption['value'] == 'blocktp3'):?>
                                        <div class="dis-slider-wrapper" >
                                          
                                            <div class="dis-slider" id="case-dev-dis-slider">
                                                <?php foreach ( $designBlock['blok_so_slajderom'] as $slide ):?>
                                                    <div class="slide">
                                                        <img src="<?php echo $slide['kartinka'];?>" alt="">
                                                    </div>
                                                <?php endforeach;?>
                                            </div>
                                        </div>
		                        ...
		                        <?php endforeach;?>
                                <?php endif;?>
                                <?php if ( $block['value'] == 'adaptive'):?>
                                    <div class="container">
                                        <div class="row dev-part">
                                            <div class="pic-text-wrapper col-12">
                                                <h3><?php echo $adaptiveBlock['podzagolovok'];?></h3>
                                                <div class="part-text">
				                                    <?php echo $adaptiveBlock['opisanie'];?>
                                                </div>
                                    ...
                                    <div class="image-wrapper">
                                        <img src="<?php echo $adaptiveBlock['kartinka'];?>" alt="">
                                    </div>
                                <?php endif;?>
                                <?php if ( $block['value'] == 'text'):?>
                                    <div class="container">
                                        <div class="row">
                                            <p>текст</p>
                                        </div>
                ...
                <?php elseif ( $caseCatContentType['value'] == 'target'):?>
                <div class="part-2">
                        <div class="container">
                            <div class="row part-item">
                                <h2 class="part-name col-sm-4"><?php echo $textWhatDid;?></h2>
                                <div class="part-about col-sm-8">
					                <?php
						                $part_items = $case_what_did['opisanie'];

						                foreach ( $part_items as $item ):
					                ?>
                                    <h3><?php echo $item['nazvanie'];?></h3>
                                    <div class="text-wrapper"><?php echo $item['opisanie'];?></div>
					                <?php
						                $pic_init = $item['dobavit_blok_i_kartinka'];

						                if ( $pic_init['value'] == 'yesimage' ):
					                ?>
					                <?php
						                $galleryLang = count($item['blok_s_kartinkami']);

						                if ( $galleryLang <= 2 ):?>
                                    <div class="part-gallery two">
						                <?php elseif ( $galleryLang == 3 ):?>
                                        <div class="part-gallery three">
							                <?php else: ?>
                                            <div class="part-gallery">
								                <?php endif;?>

								                <?php foreach ( $item['blok_s_kartinkami'] as $pic ):?>
									                <?php
									                $content_type = $pic['tip_kontenta']['value'];

									                if ( $content_type == 'image' ):
										                ?>
                                                        <a href="<?php echo $pic['kartinka'];?>" class="pic" data-fancybox="case-gallery">
                                                            <img class="lazy" src="<?php echo $pic['kartinka'];?>" alt="">
                                                        </a>
									                <?php elseif ( $content_type == 'video' ):?>
                                                        <a href="#" class="video-wrap pic" data-videoid="<?php echo $pic['video'];?>">
                                                            <img class="lazy" src="<?php echo $pic['privyu_video'];?>" alt="">
                                                        </a>
                                                    <?php elseif ( $content_type == 'video-auto' ):?>
                                                        <a href="#" class="video-wrap pic autoplay-video-wrapper">
                                                            <video data-videosrc="<?php echo $pic['video_fajl'];?>" loop="loop" src="" poster="<?php echo $pic['privyu_video'];?>" playsinline="" muted="" autoplay >
                                                            </video>
                                                        </a>
									                <?php endif;?>
                            ...
                            <div class="part-3">
                                <div class="container">
                                    <div class="row">
                                        <div class="part-item col-lg-6 col-12">
                                            <h2 class="part-name"><?php echo $textResult;?></h2>
                                            <div class="part-about"><?php echo $case_results['opisanie'];?></div>
                                        </div>
						                <?php foreach ( $case_results['grafiki'] as $schedule ): ?>
                                            <div class="part-item col-lg-4 col-6 chart">
                                                <div class="inner">
                                                    <img class="lazy" src="<?php echo $schedule['kartinka'];?>" alt="">
                                                </div>
                                            </div>
						                <?php endforeach;?>
                                    </div>
    ...
    <?php
        $siteLink = get_field('ssylka_na_sajt');

        if( $siteLink ):
    ?>
      <section class="sile-link-block">
          <div class="container">
              <div class="row">
                  <h2 class="block-title col-12"><?php echo $textThxWatch;?></h2>
              </div>
              <div class="row">
                  <div class="col-12">
                      <p><?php echo $textThxWatchTo;?> <a href="<?php echo $siteLink;?>" target="_blank"><?php echo $textThxLink;?></a></p>
                  </div>
              </div>
          </div>
      </section>
        ...
        <section class="other-project-cases">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <a href="<?php echo $item['ssylka_na_kejs'];?>" class="item col-12">
                        <span class="prev-wrapper">
                            <img src="<?php echo $item['kartinka_privyu'];?>" alt="">
                        </span>
                        <span class="info">
                            <h3><?php echo $item['zagolovok_kejsa'];?></h3>
...
<path d="M5.293 12.793L6.707 14.207L13.414 7.49997L6.707 0.792969L5.293 2.20697L9.586 6.49997L0 6.49997L0 8.49997L9.586 8.49997L5.293 12.793Z" fill="#6B799A"/>
			...
			<div class="container">
				...
				<?php
					...
					$moreCasesInCase = array(
						...
						'post_type' => 'cases',
						'orderby' 	 => 'date',
						'post__not_in' => array ($post->ID, 3636, 3555, 3828, 3828, 3873, 3870),
						'posts_per_page' => 3,
						'offset'     => 0
    ...
    if( $caseCatContentType['value'] == 'developt' ){
        $startAdd = $getAuditCaseBlockDev;

    }else{
        $startAdd = $getAuditCaseBlockTarget;
    }
											...
											<?php
												...
												if ( $media_type['value'] == 'image' ): ?>
                                                    <a href="<?php echo get_field('kartinka')?>" data-fancybox="rev">
                                                        <img src="<?php echo get_field('kartinka')?>" alt="" class="pic">
                                                    </a>
